...
public class DetailActivity extends AppCompatActivity {
    ...
    TextView foodDescription,RecipeName,Recipetype,RecipePrice;
    ImageView foodImage;
    String key="";
    String imageUrl="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Recipetype = (TextView) findViewById(R.id.type);
...
//            Recipetype.setText(mBundle.getString("Type"));
    ...
    public void btnUpdateRecipe(View view) {
        ...
        .putExtra("descriptionKey",foodDescription.getText().toString())
                        ...
                        .putExtra("priceKey",Recipetype.getText().toString())
